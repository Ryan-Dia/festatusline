...
var WidgetConfigSchema = external_exports.object({
...
var SettingsSchema = external_exports.object({
  ...
  separator: external_exports.string().default(" \u2502 ")
});

// src/config/load.ts
function getClaudeDir() {
  return process.env.CLAUDE_CONFIG_DIR ?? path.join(os2.homedir(), ".claude");
}
function getConfigPath() {
  const dir = process.env.XDG_CONFIG_HOME ?? path.join(os2.homedir(), ".config");
...
var ko = {
  ...
  "widget.weeklyRateLimit": "\uC8FC\uAC04 \uC804\uCCB4 \uD55C\uB3C4",
...
var en = {
  ...
  "widget.weeklyRateLimit": "Weekly Limit (all)",
